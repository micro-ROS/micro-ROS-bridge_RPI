...
mkdir -p ~/micro-ros_rpi/client_ws/src 
cd ~/micro-ros_rpi
...
docker run -it --rm \
    ...
    -v ~/micro-ros_rpi/client_ws:/client_ws \
    -v ~/micro-ros_rpi/ros2_raspbian_tools/build_ros2_microros_client.bash:/build_ros2.bash \
